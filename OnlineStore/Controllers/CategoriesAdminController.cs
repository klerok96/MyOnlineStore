...
namespace OnlineStore.Controllers
{
    ...
    public class CategoriesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryId,CategoryName,Visibility")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,CategoryName,Visibility")] Category category)
        {
            if (ModelState.IsValid)
            {
